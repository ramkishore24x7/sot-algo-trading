...
static_stoploss,stop_loss,stop_loss_aggressive_trailing = args.sl,args.sl,args.sl
...
def takeEntry(option, current_entry_price):
    ...
    while not traded:
        ...
        try:
            ...
            elif round(cmp) >= target2 - aggressive_trailing_points2 and not soldAtTarget2 and stop_loss_aggressive_trailing != target1:

...
# strikeList=['NSE:NIFTY50-INDEX']
instrument_name = "MIDCPNIFTY"
strikeList=['NSE:MIDCPNIFTY-INDEX']
exchangeSymbol = "NSE:"
...
for i in range(-2, 2):
    ...
    # strikeCE = exchangeSymbol+instrument_name+ expiry["year"]+expiry["month"]+expiry["day"]+str(strike+25)+"CE"
    strikeCE = exchangeSymbol+instrument_name+ expiry["year"]+expiry["month"]+str(strike+25)+"CE"
    strikeList.append(strikeCE)
    ...
    strikeList.append(strikeCE)
    # strikeCE = exchangeSymbol+instrument_name+ expiry["year"]+expiry["month"]+expiry["day"]+str(strike+75)+"CE"
    strikeCE = exchangeSymbol+instrument_name+ expiry["year"]+expiry["month"]+str(strike+75)+"CE"
    strikeList.append(strikeCE)
    ...
    # strikePE = exchangeSymbol+instrument_name+expiry["year"]+expiry["month"]+expiry["day"]+str(strike+25)+"PE"
    strikePE = exchangeSymbol+instrument_name+expiry["year"]+expiry["month"]+str(strike+25)+"PE"
    strikeList.append(strikePE)
    ...
    strikeList.append(strikePE)
    # strikePE = exchangeSymbol+instrument_name+expiry["year"]+expiry["month"]+expiry["day"]+str(strike+75)+"PE"
    strikePE = exchangeSymbol+instrument_name+expiry["year"]+expiry["month"]+str(strike+75)+"PE"
    strikeList.append(strikePE)

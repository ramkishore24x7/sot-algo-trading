...
class Config:
    ...
    accounts_range_strategy = [
        ...
        AccountConfig(name="[ SAI's Demat1 ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=True,should_average=True,config_type="Range"),
        AccountConfig(name="[ RAM's Demat1 ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=True,config_type="Range"),

        AccountConfig(name="[ SAI's Demat2 ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,should_average=True,config_type="Range"),
        AccountConfig(name="[ RAM's Demat2 ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,config_type="Range"),

        AccountConfig(name="[ SAI's Demat3 ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,await_next_target=True,should_average=True,config_type="Range"),
        AccountConfig(name="[ RAM's Demat3 ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,await_next_target=True,config_type="Range"),

        AccountConfig(name="[ Nivi's Demat1 ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,await_next_target=False,should_average=True,lazy_trail=True,config_type="Range"),
        ...
        AccountConfig(name="[ SAI's Demat1_Aggressive ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=True,should_average=True,aggressive_trail=True,config_type="Range"),
        AccountConfig(name="[ RAM's Demat1_Aggressive ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=True,aggressive_trail=True,config_type="Range"),

        AccountConfig(name="[ SAI's Demat2_Aggressive ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,should_average=True,aggressive_trail=True,config_type="Range"),
        AccountConfig(name="[ RAM's Demat2_Aggressive ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,aggressive_trail=True,config_type="Range"),

        AccountConfig(name="[ SAI's Demat3_Aggressive ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,await_next_target=True,should_average=True,aggressive_trail=True,config_type="Range"),
    ...
    accounts_breakout_strategy = [
        ...
        AccountConfig(name="[ SAI's Demat2 ]",client_id=SAI_CLIENT_ID,secret_key=SAI_SECRET_KEY,access_token=SAI_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,should_average=True,config_type="Breakout"),
        AccountConfig(name="[ RAM's Demat2 ]",client_id=RAM_CLIENT_ID,secret_key=RAM_SECRET_KEY,access_token=RAM_ACCESS_TOKEN,quantity_banknifty=PAPER_QTY_BANKNIFTY,quantity_nifty=PAPER_QTY_NIFTY,quantity_midcpnifty=PAPER_QTY_MIDCPNIFTY,quantity_finnifty=PAPER_QTY_FINNIFTY,quantity_bajfinance=PAPER_QTY_BAJFINANCE,quantity_sensex=PAPER_QTY_SENSEX,paper_trade=True,squareoff_at_first_target=False,config_type="Breakout"),
